...
/*   Updated: 2024/02/16 10:18:53 by sboetti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack(const std::string & target){
	if (this->_energy <= 0 || this->_health <= 0){
		std::cout << "ClapTrap " << this->_name << " is out of energy or is dead and cannot attack ..." << std::endl;
		return ;
	}
...
void	ClapTrap::takeDamage(unsigned int amount){
	if (this->_health > amount)
		...
		std::cout << "ClapTrap " << this->_name << " is already dead and cannot take damage !" << std::endl;
		return ;
	}
